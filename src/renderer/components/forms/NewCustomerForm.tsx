...
export const NewCustomerForm: React.FC = () => {
    ...
    const initialValues: CustomerValues = {fname:'', lname:'', phone:'', email:''};
      ...
      <div>
        <div><br/>
            <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={ValiadtionSchema}>
                <Form>
                    <div>
                    <Field id="fname" name="fname" placeholder="First Name" className="input input-bordered w-full max-w-l"/><br/>
                    <div className="text-error"><ErrorMessage name="fname" /></div>
                    </div><br/>
                    <div>
                    <Field id="lname" name="lname" placeholder="Last Name" className="input input-bordered w-full max-w-l"/><br/>
                    <div className="text-error"><ErrorMessage name="lname" /></div>
                    </div><br/>
                    <div>
                    <Field id="phone" name="phone" placeholder="Phone Number" className="input input-bordered w-full max-w-l"/><br/>
                    <div className="text-error"><ErrorMessage name="phone" /></div>
                    </div><br/>
                    <div>
                    <Field id="email" name="email" placeholder="Email Address" className="input input-bordered w-full max-w-l"/><br/>
